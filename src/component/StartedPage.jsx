...
const StartedPage = () => {
  ...
  return (
    <div className=''>
        ...
        <div className='bg-gradient-to-b from-zinc-900 to-red-900'>


        <div className='flex flex-col md:flex-row flex-wrap px-2  md:h-screen h-fit object-cover'>
        ...
        <div className='flex flex-col-reverse items-center md:flex-row flex-wrap px-2 gap-1 md:h-screen h-fit object-cover w-[100%]'>
        ...
        <div className='flex flex-col md:flex-row flex-wrap px-2 gap-6 md:gap-1 md:h-screen h-fit object-cover'>
        ...
        <div className='flex flex-col items-center gap-10 md:gap-1 md:flex-row flex-wrap px-2  h-fit md:h-screen object-cover w-[100%]'>
        ...
        <div className='text-center text-white bg-black border border-t-gray-900 py-10'>
            <p className='text-xl'>Developed by <span className='text-red-600 font-bold'>Md Adil✌️</span></p>
        </div>
    </div>
  )
}
